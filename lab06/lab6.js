...
$(document).ready(function () {
   ...
   // Use event delegation to handle clicks on both old and new list items
   $("#labList").on("click", "li", function() {
   ...
   // link to show/hide the text:
      ...
      // Toggle text when clicking the "Toggle Text" link
   $('#toggleText').click(function (event) {
         event.preventDefault(); // Prevent default link behavior
         $('#showHideBlock p').toggle(); // Toggles the visibility of the paragraphs inside #showHideBlock
   });
